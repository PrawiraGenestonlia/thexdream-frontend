      ...
      <Fragment>
        {
          showModal ?
            <div class="animated fadeIn fixed z-20 pin overflow-auto flex w-screen h-screen">
              <div class="animated fadeInUp rounded-lg bg-blue-200 shadow-inner max-w-md relative align-top ml-8 mb-40 mt-auto justify-end md:justify-center p-8 bg-white md:rounded w-4/5 md:h-auto md:shadow flex flex-col md:ml-0 bottom-0">
                <div>
